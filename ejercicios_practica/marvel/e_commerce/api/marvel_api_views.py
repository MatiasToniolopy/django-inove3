...
def get_comics(request):
    ...
    if request.GET.get('offset') != None or request.GET['offset'].isdigit() == True:
        offset =  request.GET['offset']
    else:
        offset = 0
        
    if request.GET.get('limit') != None or request.GET['limit'].isdigit() == True:
    ...
    template += f'''
                    <html>
                        ...
                        <body>
                            ...
                            <article style="background: blue">
                                <section>
                                    <div align="center">
                                        ...
                                        <p>
                                            <div style="height:90%; width:90%; overflow:auto; background:red">
                                                <table border="1px">
                                                    {html}
                                                </table>
                                            </div>
                            ...
                            <footer align="center" style="background: green;">
